    ...
    <div>
      <v-container class=" py-0 my-0"  color="">
        <v-row  class="px-0 mx-0 py-0 my-0">
          ...
          <v-col cols="12" md="1" class="mx-3" > 
            <AddButton @userClick="validerDemandes()" :textButton="'valider'" :icon="'verified'" />
          </v-col>
          <v-col cols="12" md="1" class="mx-3" >
            <DeleteButton @userClick="supprimerDemandes()" :textButton="'supprimer'" :icon="'delete'" />
          </v-col>
        </v-row>
      </v-container>
